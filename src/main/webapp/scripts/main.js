(() => {
    ...
    const setRankingTable = () => {
        ...
        for (let i = 0; i < items.length; i++) {
	        ...
	        const PreferPositionTd = document.createElement('td');
	        PreferPositionTd.innerHTML = item.PreferPositions;
	        tr.appendChild(PreferPositionTd);
	        ...
	        if (item.hasOwnProperty('dodgeWarning') && item.dodgeWarning) {
	            ...
	            PreferPositionTd.className = 'text-danger';
